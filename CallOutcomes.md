...
The following request can be used to get all call outcomes registered in Cube:

**GET** ```https://YOURACCOUNT.headshed.com/api/v1/call_outcomes/?from_date={YYYYMMDD}&to_date={YYYYMMDD}```
...
### Example response:
Request example: https://xxx.headshed.com/api/v1/call_outcomes/?from_date=20200212&to_date=20200212

```json  
{
    "count": 781,
    "next":   "https://xxxx.headshed.com/api/v1/call_outcomes/?from_date=20200212&to_date=20200212,
    "previous": null,
    "results": [
        {
...
The crm custom fields are custom fields defined on the CRM of your the Data Owner.
